<game>
            ...
            <menuButton id="0" resKey="laser.png" subAction="true" languageKey="ttip_menu_laser">
                <actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png">
                    ...
                    <actionButton id="7" resKey="laserBat5.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true" ammobar="true"/>
                    <actionButton id="8" resKey="cboFootballBat.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true" ammobar="true"/>
                    <actionButton id="39" resKey="laserBat6.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true" ammobar="true"/>
                    <actionButton id="108" resKey="laser_halloween.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true" ammobar="true"/>
                </actionButtons>
            </menuButton>
                ...
                <actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png">
                    ...
                    <section id="rocket">
                        ...
                        <actionButton id="57" resKey="plt3030.png" languageKey="ttip_rocket" alwaysExist="true"
                                      counter="true" ammobar="true" canStartAttack="true"/>
                        <actionButton id="74" resKey="bdr1211.png" languageKey="ttip_rocket" alwaysExist="true"
                                      counter="true" ammobar="true" canStartAttack="true"/>
                    ...
                    <section id="hellstorm">
                        ...
                        <actionButton id="76" resKey="sar_02.png" languageKey="ttip_rocket" alwaysExist="true"
                                      counter="true" ammobar="true"/>
                        <actionButton id="102" resKey="cbr100.png" languageKey="ttip_rocket" alwaysExist="true"
                                      counter="true" ammobar="true"/>
                        <actionButton id="109" resKey="bdr1212.png" languageKey="ttip_rocket" alwaysExist="true"
                                      counter="true" ammobar="true"/>
                    </section>
                </actionButtons>
            </menuButton>
            ...
            <menuButton id="4" resKey="fastbuy_icon.png" subAction="true" languageKey="ttip_menu_fastbuy">
                <actionButtons stdIcon="comb04_std.png" hoverIcon="comb04_hover.png" selectedIcon="comb04_selected.png">
                    ...
                    <actionButton id="28" resKey="laserBat3.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true"/>
                    <actionButton id="30" resKey="laserBat5.png" languageKey="ttip_laser" alwaysExist="true"
                                  counter="true"/>
    ...
    <patterns>
        ...
        <resolutions>
            ...
            <resolution id="0" width="820" height="600" mainMenuXPos="318" mainMenuYPos="503" slotMenuXPos="281"
                        slotMenuYPos="474" premslotMenuXPos="297" premslotMenuYPos="444">
            ...
            <resolution id="1" width="1024" height="576" mainMenuXPos="349" mainMenuYPos="480" slotMenuXPos="312"
            ...
            <resolution id="2" width="1024" height="720" mainMenuXPos="394" mainMenuYPos="622" slotMenuXPos="358"
            ...
            <resolution id="3" width="1280" height="720" mainMenuXPos="514" mainMenuYPos="623" slotMenuXPos="478"
            ...
            <resolution id="4" width="1280" height="900" mainMenuXPos="536" mainMenuYPos="801" slotMenuXPos="499"
            ...
            <!-- high client resolution 4:3 -->
            <resolution id="5" width="1920" height="979" mainMenuXPos="318" mainMenuYPos="503" slotMenuXPos="281"
                        slotMenuYPos="474" premslotMenuXPos="297" premslotMenuYPos="444">
                <minimizedIconSlots x="25" y="200">
                    <minimizedIconSlot iconXPos="0" iconYPos="0"/>
                    <minimizedIconSlot iconXPos="-17" iconYPos="29"/>
        ...
        <droneFormations>
            <formation id="0" name="standard">
                ...
                <positionsList
                        data="150,0;225,0;187.5,37.5;187.5,-37.5;-37.5,-150;37.5,-150;0,-112.5;0,-187.5;-37.5,150;37.5,150;0,187.5;0,112.5"/>
                <scale>1.0</scale>
        ...
        <bannerads>
            ...
            <bannerad id="10" enumName="partner_antec" baseKey="partner_antec" assetCount="1"
