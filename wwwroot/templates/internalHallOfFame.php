    ...
    <div class="shop-header">
        <nav class="shop-navigation">
            <ul class="nav nav-justified">
                <li class="your-rank active"><a onclick="hof('rank');" href="#"></a>
                </li>
                <li class="top-exp"><a onclick="hof('ep');" href="#"></a>
                </li>
                <li class="top-honor"><a onclick="hof('hon');" href="#"></a>
                </li>
                <li class="top-user"><a onclick="hof('topuser');" href="#"></a>
                </li>
                <li class="top-clan">
                    ...
                    <div class="single-item-description col-xs-8">
                        ...
                        <div class="explanation">
                            <div class="none">
                                ...
                                <center>You currently have the highest rank. <img class="ranking-icon"
                                    ...
                                    instance, are divided by 100,000 and added to other balanced values, which is how we
                                    determine your total Rank Points.<p><br/>

                                        <?php if ($System->User->RANK == 1){ ?>

                                    <p><?php echo "You need approximately " . number_format($System->User->RANK_POINTS - $System->User->getNextRank(), 0, '.', ',') . " rank points to reach the next rank of <b>" . $System->User->getNextRankN() . "</b>"; ?>
                                        <img class="ranking-icon"
                                             src="/do_img/global/ranks/rank_<?php echo($System->User->RANK + 1); ?>.gif">.<br/>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        <?php } elseif ($System->User->RANK == 20) { ?>

                                        You currently have the highest rank. <img class="ranking-icon"
                                                                                  src="/do_img/global/ranks/rank_<?php echo($System->User->RANK); ?>.gif"><br/>
                                    <p>

                                        The rank directly below yours is that of <b><?php echo $rankbelow; ?></b><img
                                                class="ranking-icon"
                                                src="/do_img/global/ranks/rank_<?php echo($System->User->RANK - 1); ?>.gif">.
                                    ...
                                    <p>
                                        ...
                                        <Br/>
                                    <p>The rank directly below yours is that of <b><?php echo $rankbelow; ?></b><img
                                                class="ranking-icon"
                                                src="/do_img/global/ranks/rank_<?php echo($System->User->RANK - 1); ?>.gif">.
                                        Space pilots with this rank have
                                        approximately <?php echo number_format($rankbelowp, 0, '.', ',') ?> rank points.<Br/>
