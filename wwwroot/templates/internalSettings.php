    ...
    <div class="modal-dialog" >
        <div class="modal-content" style="background-image:url(../do_img/global/bg_event_winter.jpg);">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group" style="text-align:center; margin-left:10px; top:20px; left:50px;">
                        <label  class="col-sm-2 control-label" style="left:100px; top:-3px;"
                                for="inputEmail3">recipient: </label>
                        <div class="col-sm-10">
                            <input type="text" id="recipient" value="" style="margin-left:-100px;background-color: black;color:#fff;" enabled="enabled"/>
                        </div>
                    </div>

                    <div class="form-group" style="text-align:center; margin-left:10px; margin-top:0px;">
                        <label  class="col-sm-2 control-label" style="left: 100px; top:-5px;"
                                for="inputEmail3">Header: </label>
                    ...
                    <div class="form-group" style="margin-left:0px; width:700px;">
                        <div class="col-sm-10">
                            <textarea id="editornew" name="Content" value="" style="width: 700px; height: 200px;" placeholder="Message..." ></textarea>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button id="senmd" type="submit" class="btn btn-primary">Send</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content" style="background-image:url(../do_img/global/bg_event_winter.jpg);">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                  <div class="form-group" style="text-align:center; margin-left:10px; top:20px; left:50px;">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="userNameTextBox" value="<?= $System->User->PLAYER_NAME ?>" style="background-color: black;color:#fff;" enabled="enabled"/>
                    </div>
                 </div>
                ...
                <div class="form-group" style="text-align:center; margin-left:10px; left:50px;">
                    ...
                    <div class="col-sm-10" style="top:-25px;">
                        <input type="text" value="<?= $System->User->USERNAME ?>" style="background-color: black;color:#fff;" disabled="disabled">
                    </div>
                </div>

                  <div class="form-group" style="text-align:center; margin-left:10px;  left:50px;">
                    <label style ="width:130px; float:left;"class="col-sm-2 control-label"
                          for="inputPassword3" >Date of Birth:</label>
                    <div class="col-sm-10" style="top:-23px; left:85px;">
                        <select style="background-color:black; width:100px;" name="diploForm" id="diploForm" class="clan-list fliess10px-black">
                ...
                <div class="form-group" style="text-align:center; margin-left:10px; top:20px; left:50px;">
                    <label  class="col-sm-2 control-label"
                              for="inputEmail3">Discord: </label>
                    <div class="col-sm-10">
                        <input type="text" value="<?= $System->User->DISCORD_ID ?>" style="background-color: black;color:#fff;">
                    </div>
                </div>
                </form>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary"
                   style="cursor: pointer; top:0px; position:relative">Save Changes</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    jQuery('#changename').click(function() {
        jQuery.ajax({
            type: "POST",
            url: "",
            data: { action: 'changePilotName', subAction: 'changename',userName: jQuery('#userNameTextBox').val() },
            success: function(){
                console.log(data);
            },
            error: function(){
    ...
    jQuery('#senmd').click(function(){
        jQuery.ajax({
            type: "POST",
            url: "",
            data: { action: 'send', subAction: 'sendmessage', userName: jQuery('#recipient').val(), Content: jQuery('#editornew').val(), Header: jQuery('#headert').val() },
            success: function(){
