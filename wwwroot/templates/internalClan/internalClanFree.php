    ...
    <div class="clan-top-cotainer">
        <div class="clan-top-content clearfix">
            <div class="main-clan-info">
                <input id="clan-tag" class="form-control clan-textbox" maxlength="4" placeholder="Clan Tag">
                <input id="clan-name" class="form-control clan-textbox" maxlength="24" placeholder="Clan Name">
                <textarea id="clan-desc" class="form-control clan-textbox" maxlength="128" placeholder="Clan Description"></textarea>
            </div>
            <div class="clan-top-send col-xs-12 margin-top">
                <a id="create-clan" class="btn btn-block btn-primary">Create</a>
            </div>
        </div>
    </div>
