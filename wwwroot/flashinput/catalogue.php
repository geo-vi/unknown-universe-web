...
<script language="javascript">window.BpEventStream = window.BpEventStream || {
        ...
        "context": {
            ...
            "iid": "ec2d5d4a8987f82bebd6606879695ba6",
                        ...
                        <form method="post" name="bgc_signup_form" class="bgc_signup_form" autocomplete="off"
                            ...
                            <div class="bgcdw_captcha" id="id7D58CB30_0">
                                ...
                                <script type="text/javascript">var RecaptchaOptions = {
                                        'theme': 'custom',
                                        'custom_theme_widget': 'id7D58CB30_0'
                                    };
                                    Recaptcha.create('6Ldud8cSAAAAAM5W4-JHqa2vEQuqEX19LN8HLQIl', 'id7D58CB30_0', RecaptchaOptions);</script>
                            </div>
