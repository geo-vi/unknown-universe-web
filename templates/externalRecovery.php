...
<div class="login-form-wrapper">
    <nav>
        <ul class="nav nav-tabs nav-justified" role="tablist">
            <li role="presentation" class="active"><a href="#account-recovery" aria-controls="account-recovery"
                                                      role="tab" data-toggle="tab">Account Recovery</a></li>
        </ul>
    </nav>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="account-recovery">
            ...
            <form class="recovery-form" method="post">
                <input type="text" id="recoveryUsername" name="recoveryUsername" class="form-input"
                       placeholder="Username" required autofocus>
                <input type="email" id="recoveryEmail" class="form-input" name="recoveryEmail" placeholder="E-Mail"
                       required>
