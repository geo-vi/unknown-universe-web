<game>
	...
	<windows>
        ...
        <window titleKey="title_clanvisibility" icon="clan_member_online_visibility.png" id="43" x="5" y="5" width_0="10" height_0="10" closeable="false" slotType="left" hudToggle="true" saveSettings="true"  helpKey="httip_clanvisibility" startMinimized="true" transparency="true"></window>
        <window titleKey="title_wordpuzzle" icon="puzzle.png" id="44" x="5" y="5" width_0="10" height_0="10" closeable="false" slotType="left" hudToggle="true" saveSettings="true"  helpKey="title_wordpuzzle" startMinimized="true" transparency="true"></window>
        <window titleKey="title_countdownHalloweenNpcs" icon="countdown_status_halloween_npc_icon.png" id="45" x="5" y="5" width_0="10" height_0="10" closeable="false" slotType="left" hudToggle="true" saveSettings="true"  helpKey="httip_countdownHalloweenNPCs" startMinimized="true" transparency="true"></window>

        <!-- hero window -->
        <window titleKey="title_ship" icon="ship_icon.png" id="1" shortcut="SI" x="670" y="5" width_0="200" height_0="96" width_1="254" height_1="112" closeable="false" slotType="left" hudToggle="true" saveSettings="true" helpKey="httip_ship" transparency="true">
            ...
            <infoFieldContainer id="14" x_0="112" y_0="35" x_1="150" y_1="35" textFieldWidth="110">
                ...
                <infoField id="26" linkage="shipInfoIcon_laser" bar="bar_red,bar_red_transparent" languageKey="ttip_ammunition"/>
                <infoField id="27" linkage="shipInfoIcon_rockets" bar="bar_red,bar_red_transparent" languageKey="ttip_rockets"/>
            </infoFieldContainer>
        </window>

		<window titleKey="title_connection_info" id="8" x="center" y="center" width_0="300" height_0="210" maximizeOnCreate="true"/>
		<window titleKey="title_connection_lost" id="12" x="center" y="center" width_0="300" height_0="250" maximizeOnCreate="true"/>
		...
		<window titleKey="title_settings" icon="settings_icon.png" id="4" shortcut="ST" x="10" y="10" width_0="400" height_0="464" startMinimized="true" slotType="static"/>
		...
		<window titleKey="title_ifg" icon="infiltration_game.png" id="42" shortcut="TD" x="10" y="10" width_0="220" height_0="55" slotType="left" saveSettings="true" hudToggle="true" transparency="true">
		...
		<window titleKey="title_startupquests" id="32" icon="achievements_icon.png" x="center" y="center" width_0="460" height_0="180" resizable="true" slotType="left" saveSettings="true" startMinimized="false" transparency="true"/>
		...
		<window titleKey="title_network" id="35"  x="0" y="400" width_0="250" height_0="200" resizable="false" slotType="left" saveSettings="true" startMinimized="false" transparency="true"/>
        ...
        <window titleKey="title_ranked_hunt" id="37" icon="npc_hunt_icon.png" x="10" y="10" width_0="200" height_0="55" resizable="false" slotType="left" saveSettings="true" startMinimized="true" transparency="true" hudToggle="true">
        ...
        <window titleKey="title_highscoregate" id="38" icon="highscore_gate_icon.png" x="10" y="10" width_0="225" height_0="55" resizable="false" slotType="left" saveSettings="true" startMinimized="false" transparency="true" hudToggle="true">
        ...
        <window titleKey="title_captcha" id="39" icon="captcha_icon.png" x="10" y="10" width_0="320" height_0="150" resizable="false" slotType="left" saveSettings="false" startMinimized="false" transparency="true" hudToggle="true">
			<containers>
        ...
        <window titleKey="title_scoreevent" id="40" icon="score_fest_icon.png" x="10" y="10" width_0="200" height_0="100" resizable="false" slotType="left" saveSettings="true" startMinimized="false" transparency="true" hudToggle="true">
			<infoFieldContainer id="66" x_0="15" y_0="35">
				<infoField id="93" languageKey="ttip_scoreevent_lives_remaining" textColor="ffffff" linkage="lives_scorefest"/>
			</infoFieldContainer>
		...
		<window titleKey="title_sectorcontrol_ingame_status" icon="sector_control.png" id="47" x="10" y="10" width_0="200" height_0="100" slotType="left" saveSettings="true" />		
		<window titleKey="title_jackpot_status_ui" icon="icons_jackpot" width_0="430" height_0="340" id="48" x="center" y="center" closeable="false" slotType="left" hudToggle="true" startMinimized="false" saveSettings="true">
			<containers>
	...
	<settingsGameplay>
		...
		<settingField id="25" key="auto_refinement" tooltipKey="ttip_auto_refinement"/> <!-- Auto-refine raw materials -->
...
<!-- 		<settingField id="33" key="setting_displayEngineSmoke"/> -->
	...
	<settingsDisplay>
		<!--<settingField id="32" type="combobox" key="setting_resolution">
			<item value="0" languageKey="setting_resolution_820x600"/>
			<item value="1" languageKey="setting_resolution_1024x576"/>
			<item value="2" languageKey="setting_resolution_1024x720"/>
			<item value="3" languageKey="setting_resolution_1280x720"/>
			<item value="4" languageKey="setting_resolution_1280x900"/>
			<item value="5" languageKey="setting_resolution_fullscreen"/>
		</settingField>-->
	...
	<tradeWindow>
		<ores>
			<ore type="0" pricetag="pricetag_credits_compact" languageKey="sta_prometium" pricetagTooltipKey="ttip_pricetag_credits_default" />
			<ore type="1" pricetag="pricetag_credits_compact" languageKey="sta_endurium" pricetagTooltipKey="ttip_pricetag_credits_default" />
			<ore type="2" pricetag="pricetag_credits_compact" languageKey="sta_terbium" pricetagTooltipKey="ttip_pricetag_credits_default" />
			<ore type="4" pricetag="pricetag_credits_compact" languageKey="sta_prometid" pricetagTooltipKey="ttip_pricetag_credits_default" />
			<ore type="5" pricetag="pricetag_credits_compact" languageKey="sta_duranium" pricetagTooltipKey="ttip_pricetag_credits_default" />
			<ore type="6" pricetag="pricetag_credits_compact" languageKey="sta_promerium" pricetagTooltipKey="ttip_pricetag_credits_default" />
...
<!--					<actionButton id="0" resKey="laser.png" alwaysExist="true" languageKey="ttip_laser_activate" customizable="false"/>-->
					...
					<actionButton id="8" resKey="cboFootballBat.png" languageKey="ttip_laser" alwaysExist="true" counter="true" ammobar="true"/>
					<actionButton id="39" resKey="laserBat6.png" languageKey="ttip_laser" alwaysExist="true" counter="true" ammobar="true"/>
					<actionButton id="108" resKey="laser_halloween.png" languageKey="ttip_laser" alwaysExist="true" counter="true" ammobar="true"/>
				</actionButtons>
			</menuButton>
			...
			<menuButton id="1" resKey="rocket.png" subAction="true" languageKey="ttip_menu_rockets">
				<actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png" >
					...
					<section id="rocket">
						...
						<actionButton id="74" resKey="bdr1211.png" languageKey="ttip_rocket" alwaysExist="true" counter="true" ammobar="true" canStartAttack="true"/>
...
<!--						activate selects rocket type to be loaded in rocket launcher-->
						...
						<actionButton id="75" resKey="sar_01.png" languageKey="ttip_rocket" alwaysExist="true" counter="true" ammobar="true"/>
						<actionButton id="76" resKey="sar_02.png" languageKey="ttip_rocket" alwaysExist="true" counter="true" ammobar="true"/>
						<actionButton id="102" resKey="cbr100.png" languageKey="ttip_rocket" alwaysExist="true" counter="true" ammobar="true"/>
						<actionButton id="109" resKey="bdr1212.png" languageKey="ttip_rocket" alwaysExist="true" counter="true" ammobar="true"/>
					</section>
				</actionButtons>
			</menuButton>
			...
			<menuButton id="2" resKey="explosive.png" subAction="true" languageKey="ttip_menu_explosives">
				<actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png">
					...
					<actionButton id="103" resKey="sl_m01.png" languageKey="ttip_explosive" counter="true" alwaysExist="true" cooldown="true" ammobar="true"/>
			...
			<menuButton id="3" resKey="cpu.png" subAction="false" languageKey="ttip_menu_cpus">
				<actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png">
					...
					<actionButton id="18" resKey="petfuel.png" languageKey="ttip_fuelbuy" alwaysExist="false" active="false"/>
				</actionButtons>
			</menuButton>
...
<!--					<actionButton id="60" resKey="speed_leech.png" languageKey="SPEED_LEECH_name" alwaysExist="true" counter="true"/>-->
			...
			<menuButton id="6" resKey="ability.png" subAction="false" languageKey="ttip_menu_abilities">
				<actionButtons stdIcon="comb02_std.png" hoverIcon="comb02_hover.png" selectedIcon="comb02_selected.png" >
					...
					<actionButton id="90" resKey="repair_hp.png" languageKey="ttip_AEGIS_REPAIRHP_skill" alwaysExist="false" counter="true"/>
					<actionButton id="93" resKey="recharge_shield.png" languageKey="ttip_AEGIS_SHIELDRECHARGE_skill" alwaysExist="false" counter="true"/>
					<actionButton id="94" resKey="healing_pod.png" languageKey="ttip_AEGIS_HEALINGPOD_skill" alwaysExist="false" counter="true"/>
					<actionButton id="91" resKey="draw_fire.png" languageKey="ttip_CITADEL_DRAWFIRE_skill" alwaysExist="false" counter="true"/>
					<actionButton id="96" resKey="travelMode.png" languageKey="ttip_CITADEL_TRAVELMODE_skill" alwaysExist="false" counter="true"/>
					<actionButton id="97" resKey="protect.png" languageKey="ttip_CITADEL_PROTECTION_skill" alwaysExist="false" counter="true"/>
					<actionButton id="98" resKey="fortify.png" languageKey="ttip_CITADEL_FORTIFY_skill" alwaysExist="false" counter="true"/>
					<actionButton id="92" resKey="ultimate_cloaking.png" languageKey="ttip_SPEARHEAD_ULTIMATECLOAKING_skill" alwaysExist="false" counter="true"/>
					<actionButton id="95" resKey="mark_target.png" languageKey="ttip_SPEARHEAD_MARKTARGET_skill" alwaysExist="false" counter="true"/>
					<actionButton id="99" resKey="ultimate_emp.png" languageKey="ttip_SPEARHEAD_JAMX_skill" alwaysExist="false" counter="true"/>
					<actionButton id="100" resKey="double_minimap_reveal.png" languageKey="ttip_SPEARHEAD_DOUBLEMINIMAP_skill" alwaysExist="false" counter="true"/>
				</actionButtons>
			</menuButton>
...
<!-- 			fullscreen -->
			...
			<!--<button id="105" resKey="company_hierarchy_icon.png" iconXPos="15" iconYPos="76" languageKey="ttip_company_hierarchy_btn"/>-->
			<button id="101" resKey="ship_warping_function_icon" iconXPos="16" iconYPos="18" languageKey="ttip_shipWarp_btn"/>
	...
	<patterns>
		...
		<resolutions>
			...
			<resolution id="0" width="820" height="600" mainMenuXPos="318" mainMenuYPos="503" slotMenuXPos="281" slotMenuYPos="474" premslotMenuXPos="297" premslotMenuYPos="444" >
				...
				<windows>
					...
					<window comment="WINDOW_CLASS_MINIMAP" id="3" xPos="512" yPos="374"/>
					...
					<window comment="WINDOW_CLASS_HIGH_SCORE_GATE" id="38" xPos="550" yPos="80"/>
					<window comment="WINDOW_CLASS_CAPTCHA" id="39" xPos="280" yPos="0"/>
					...
					<window comment="WINDOW_CLASS_SECTOR_CONTROL" id="47" xPos="628" yPos="193"/>
					<window comment="WINDOW_CLASS_JACKPOT_STATUS_UI" id="48" xPos="center" yPos="center"/>
				</windows>
			</resolution>

			<!-- mid client resolution 16:9 -->
			<resolution id="1" width="1024" height="576" mainMenuXPos="349" mainMenuYPos="480" slotMenuXPos="312" slotMenuYPos="451" premslotMenuXPos="365" premslotMenuYPos="421">
				<minimizedIconSlots x="25" y="200">
					<minimizedIconSlot iconXPos="0" iconYPos="0"/>
					<minimizedIconSlot iconXPos="-17" iconYPos="29"/>
					<minimizedIconSlot iconXPos="17" iconYPos="29"/>
		  ...
		  <!-- mid client resolution 4:3 -->
			<resolution id="2" width="1024" height="720" mainMenuXPos="394" mainMenuYPos="622" slotMenuXPos="358" slotMenuYPos="592" premslotMenuXPos="374" premslotMenuYPos="562">
				<minimizedIconSlots x="25" y="200">
					<minimizedIconSlot iconXPos="0" iconYPos="0"/>
					<minimizedIconSlot iconXPos="-17" iconYPos="29"/>
					<minimizedIconSlot iconXPos="17" iconYPos="29"/>
		  ...
		  <!-- high client resolution 16:9 -->
			<resolution id="3" width="1280" height="720" mainMenuXPos="514" mainMenuYPos="623" slotMenuXPos="478" slotMenuYPos="593" premslotMenuXPos="494" premslotMenuYPos="563">
				<minimizedIconSlots x="25" y="200">
					<minimizedIconSlot iconXPos="0" iconYPos="0"/>
					<minimizedIconSlot iconXPos="-17" iconYPos="29"/>
					<minimizedIconSlot iconXPos="17" iconYPos="29"/>
			...
			<resolution id="4" width="1280" height="900" mainMenuXPos="536" mainMenuYPos="801" slotMenuXPos="499" slotMenuYPos="772" premslotMenuXPos="515" premslotMenuYPos="742">
				<minimizedIconSlots x="25" y="200">
					<minimizedIconSlot iconXPos="0" iconYPos="0"/>
					<minimizedIconSlot iconXPos="-17" iconYPos="29"/>
					<minimizedIconSlot iconXPos="17" iconYPos="29"/>
		  ...
		  <!-- resolution for open social network -->
		  			<!-- high client resolution 4:3 --> 
			<resolution id="5" width="1920" height="979" mainMenuXPos="318" mainMenuYPos="503" slotMenuXPos="281" slotMenuYPos="474" premslotMenuXPos="297" premslotMenuYPos="444"> 
				<minimizedIconSlots x="25" y="200"> 
					<minimizedIconSlot iconXPos="0" iconYPos="0" /> 
					<minimizedIconSlot iconXPos="-17" iconYPos="29" /> 
					<minimizedIconSlot iconXPos="17" iconYPos="29" /> 
...
<!-- 			<resource resKey="battleModules" /> -->
	...
	<!-- Ships .............................................................................................................................
		...
		<backgrounds layers="1">
			...
			<background content="resource" type="1016" resKey="background16-210x131" resKeyStarling="background16-4200x2620" isTiled="true" isReloadable="true" tileWidth="210" tileHeight="131" order="ASC"/>
			<background content="resource" type="1029" resKey="background29-210x131" resKeyStarling="background29-4200x2620" isTiled="true" isReloadable="true" tileWidth="210" tileHeight="131" order="ASC"/>
			<background content="resource" type="1091" resKey="background91-210x131" resKeyStarling="background91-4200x2620" isTiled="true" isReloadable="true" tileWidth="210" tileHeight="131" order="ASC"/>
			<background content="resource" type="1093" resKey="background93-210x131" resKeyStarling="background93-4200x2620" isTiled="true" isReloadable="true" tileWidth="210" tileHeight="131" order="ASC"/>
			...
			<background content="resource" type="2001" resKey="stars2_50x50" resKeyStarling="stars2_50x50_texture" atlasXml="stars2_50x50_atlasXml"  isTiled="true" tileWidth="50" tileHeight="50"/>
			<background content="resource" type="2011" resKey="asteroids_small_blue" resKeyStarling="asteroids_small_blue_texture" atlasXml="asteroids_small_blue_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2012" resKey="asteroids-small-green" resKeyStarling="asteroids-small-green_texture" atlasXml="asteroids-small-green_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2013" resKey="asteroids-small-darkred" resKeyStarling="asteroids-small-darkred_texture" atlasXml="asteroids-small-darkred_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2014" resKey="asteroids-small-yellow" resKeyStarling="asteroids-small-yellow_texture" atlasXml="asteroids-small-yellow_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2015" resKey="asteroids-small-lightblue" resKeyStarling="asteroids_small_lightblue_texture" atlasXml="asteroids_small_lightblue_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>			
			<background content="resource" type="2016" resKey="asteroids2_small_blue" resKeyStarling="asteroids2_small_blue_texture" atlasXml="asteroids2_small_blue_atlasXml" isTiled="true" tileWidth="200" tileHeight="200"/>	
			<background content="resource" type="2022" resKey="clouds-blue" resKeyStarling="clouds_blue_texture" atlasXml="clouds_blue_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2023" resKey="clouds-lightblue" resKeyStarling="clouds-lightblue_texture" atlasXml="clouds-lightblue_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2024" resKey="clouds-grey" resKeyStarling="clouds_grey_texture" atlasXml="clouds_grey_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="2025" resKey="clouds-green" resKeyStarling="clouds-green_texture" atlasXml="clouds-green_atlasXml" isTiled="true" tileWidth="300" tileHeight="300" />
			<background content="resource" type="2026" resKey="clouds-darkred" resKeyStarling="clouds-darkred_texture" atlasXml="clouds-darkred_atlasXml" isTiled="true" tileWidth="256" tileHeight="256" />
			<background content="resource" type="2027" resKey="clouds-green-yellow" resKeyStarling="clouds-green-yellow_texture" atlasXml="clouds-green-yellow_atlasXml" isTiled="true" tileWidth="256" tileHeight="256" />
			<background content="resource" type="2028" resKey="clouds-yellow" resKeyStarling="clouds-yellow_texture" atlasXml="clouds-yellow_atlasXml" isTiled="true" tileWidth="256" tileHeight="256" />
	
			<!-- poizones begin -->
			<background content="resource" type="3000" resKey="asteroid_desert" resKeyStarling="asteroid_desert_texture" atlasXml="asteroid_desert_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="3001" resKey="asteroid_desert_simple" resKeyStarling="asteroid_desert_simple_texture" atlasXml="asteroid_desert_simple_atlasXml" isTiled="true" tileWidth="128" tileHeight="128"/>
			<background content="resource" type="3002" resKey="asteroid_pirates" resKeyStarling="asteroid_pirates_texture" atlasXml="asteroid_pirates_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="3003" resKey="asteroid_pirates_simple" resKeyStarling="asteroid_pirates_simple_texture" atlasXml="asteroid_pirates_simple_atlasXml" isTiled="true" tileWidth="128" tileHeight="128"/>
			<background content="resource" type="3004" resKey="scrap_pirates" resKeyStarling="scrap_pirates_texture" atlasXml="scrap_pirates_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="3005" resKey="scrap_pirates_simple" resKeyStarling="scrap_pirates_simple_texture" atlasXml="scrap_pirates_simple_atlasXml" isTiled="true" tileWidth="128" tileHeight="128"/>	
			<background content="resource" type="3006" resKey="nebula_pirates" resKeyStarling="nebula_pirates_texture" atlasXml="nebula_pirates_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="3007" resKey="nebula_pirates_simple" resKeyStarling="nebula_pirates_simple_texture" atlasXml="nebula_pirates_simple_atlasXml" isTiled="true" tileWidth="128" tileHeight="128"/>
			<background content="resource" type="3008" resKey="asteroid_blue" resKeyStarling="asteroid_blue_texture" atlasXml="asteroid_blue_atlasXml" isTiled="true" tileWidth="256" tileHeight="256"/>
			<background content="resource" type="3009" resKey="asteroid_blue_simple"  resKeyStarling="asteroid_blue_simple_texture" atlasXml="asteroid_blue_simple_atlasXml" isTiled="true" tileWidth="128" tileHeight="128"/>
			<!-- poizones end -->
			...
			<!-- STARLING BG REFACTOR -->
			<background content="resource" type="4001" resKey="freighter-210x131" resKeyStarling="freighter-4200" isTiled="true" isReloadable="true" tileWidth="210" tileHeight="131" order="ASC" showInStarlingMode="true"/>
		...
		<expansions>
            ...
            <expansion class="19">
				...
				<positionsList name="standard" data="-4.5,14.0,-4.5,13.5,-4.0,13.0,-3.6,12.1,-3.1,11.7,-2.7,11.7,-1.8,11.2,-1.3,11.2,-0.5,11.2,0.5,11.2,0.9,11.2,1.8,11.7,2.2,12.1,2.7,12.1,3.2,13.0,3.6,13.5,3.6,14.0,3.6,14.4,3.2,14.8,3.2,15.8,2.2,15.8,1.8,16.2,0.9,16.6,0.5,16.6,-0.5,16.6,-1.3,16.6,-1.8,16.6,-2.7,16.2,-3.1,16.2,-3.6,15.8,-4.0,14.8,-4.5,14.4"/>
            ...
            <expansion class="11">	
				<positionsList name="leftFrontInner" data="-87.2,26.8,-92.4,14.4,-93.6,1.6,-91.6,-11.2,-86.0,-23.2,-77.2,-34.8,-65.2,-44.4,-50.8,-52.4,-34.4,-58.0,-16.8,-61.6,1.6,-62.8,19.6,-61.2,37.2,-57.2,53.2,-50.8,66.8,-42.4,78.4,-32.4,86.8,-21.2,91.6,-8.8,93.2,4.0,90.8,16.8,85.2,29.2,76.4,40.0,64.4,50.0,50.0,58.0,33.6,63.6,16.0,67.2,-2.0,68.4,-20.4,66.8,-37.6,62.8,-53.6,56.4,-67.6,48.0,-79.2,38.0"/>
				<positionsList name="center" data="1.6,-0.8,1.6,-0.8,1.6,-0.4,1.2,0.0,0.8,0.0,0.8,0.4,0.4,0.4,0.0,0.4,-0.4,0.4,-0.8,0.4,-1.2,0.4,-1.6,0.0,-2.0,0.0,-2.0,-0.4,-2.4,-0.4,-2.4,-0.8,-2.4,-1.2,-2.4,-1.2,-2.0,-1.6,-2.0,-1.6,-1.6,-2.0,-1.2,-2.0,-1.2,-2.4,-0.8,-2.4,-0.4,-2.4,0.0,-2.4,0.4,-2.4,0.8,-2.0,1.2,-2.0,1.2,-1.6,1.6,-1.6,1.6,-1.2"/>
				<positionsList name="rightFrontInner" data="-87.2,-20.4,-79.2,-32.0,-68.0,-42.0,-54.0,-50.4,-38.4,-56.8,-20.8,-60.8,-2.8,-62.4,15.2,-61.6,32.8,-58.0,49.2,-52.4,63.6,-44.4,75.6,-34.8,84.8,-24.0,90.4,-11.6,92.8,1.2,91.6,14.0,86.8,26.0,78.4,37.6,67.2,47.6,53.6,56.0,37.6,62.4,20.4,66.4,2.0,68.0,-16.0,67.2,-33.6,63.6,-50.0,58.0,-64.4,50.0,-76.4,40.4,-85.6,29.2,-91.2,17.2,-93.6,4.4,-92.4,-8.4"/>
	        	<stage id="1" >
		        	<salvo laser="center" />  
			...
			<expansion class="27">
				<positionsList name="bottomInner" data="-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0,-5.0,28.0"/>
				<stage id="1">
					<salvo laser="bottomInner" />
				</stage>	
			</expansion>
			<expansion class="34">
				<positionsList name="leftFrontInner" data="-44.0,34.8,-50.8,27.6,-55.6,19.6,-58.0,11.6,-58.0,3.6,-56.0,-4.4,-51.6,-11.6,-46.0,-17.6,-38.8,-23.2,-30.4,-27.6,-21.6,-30.8,-12.0,-32.8,-2.0,-33.6,8.0,-33.2,17.6,-31.6,26.8,-28.8,35.6,-24.8,42.8,-19.6,49.2,-13.6,54.0,-6.8,56.8,0.8,57.6,8.8,56.0,17.2,52.0,25.2,45.6,32.4,37.2,38.8,26.4,44.0,14.4,47.2,2.0,48.8,-11.2,48.0,-23.6,45.2,-34.4,40.8"/>
				<positionsList name="rightFrontInner" data="-36.4,-24.4,-27.6,-28.4,-18.8,-31.2,-8.8,-32.8,0.8,-33.2,10.8,-32.4,20.4,-30.4,29.2,-27.2,37.6,-23.2,44.8,-18.0,50.4,-11.6,54.4,-4.4,56.8,3.2,56.8,11.2,54.4,19.2,50.0,27.2,42.8,34.4,34.0,40.4,22.8,44.8,10.8,47.6,-2.0,48.4,-14.8,46.8,-26.4,44.0,-37.2,38.8,-45.6,32.4,-52.0,25.2,-56.0,17.2,-57.6,9.2,-57.2,1.2,-54.4,-6.4,-50.0,-13.2,-43.6,-19.2"/>
            ...
            <expansion class="67">
             ...
             <expansion class="69">
				...
				<positionsList name="fortified" data="0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0,0.0,-90.0"/>
			...
			<expansion class="74">
				<positionsList name="center_middle_" data="-158.4,9.0,-154.8,-15.3,-144.9,-38.7,-127.8,-60.3,-105.3,-79.2,-79.2,-94.5,-47.7,-105.3,-14.4,-112.5,19.8,-115.2,54.0,-112.5,87.3,-104.4,117.0,-92.7,144.0,-77.4,165.6,-57.6,181.8,-36.0,190.8,-12.6,194.4,11.7,189.9,36.0,180.0,59.4,162.9,81.0,141.3,99.9,114.3,115.2,83.7,126.9,50.4,133.2,16.2,135.9,-18.0,133.2,-51.3,126.0,-81.9,113.4,-108.0,98.1,-129.6,79.2,-145.8,56.7,-155.7,33.3"/>			
				<stage id="1">
			...
			<expansion class="76">
				<positionsList name="bottomInner" data="-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5,-2.0,27.5"/>
				<stage id="1">
					<salvo laser="bottomInner" />
				</stage>
			</expansion>
...
<!-- 			Unindentified Battleship -->
			<expansion class="102">
				...
				<positionsList name="leftFrontOuter" data="-168.0,29.0,-169.0,5.0,-164.0,-18.0,-152.0,-40.0,-134.0,-60.0,-111.0,-77.0,-84.0,-90.0,-53.0,-100.0,-21.0,-105.0,12.0,-105.0,45.0,-101.0,76.0,-93.0,104.0,-80.0,128.0,-64.0,147.0,-45.0,160.0,-23.0,168.0,0.0,169.0,23.0,163.0,46.0,151.0,68.0,133.0,88.0,110.0,105.0,83.0,118.0,53.0,128.0,20.0,133.0,-13.0,133.0,-46.0,129.0,-77.0,121.0,-105.0,108.0,-129.0,92.0,-148.0,73.0,-161.0,52.0"/>
	  ...
	  <portals>
		  	...
		  	<portal id="13" resKey="5thBdayGate" width="320" height="320" soundID="5" textX="3" textY="-20" displayTextKey="gate_billboard_birthday_5"/>
		  	<portal id="14" resKey="highScoreGate1" width="320" height="320" soundID="5" textX="3" textY="10"/>
		  	<portal id="15" resKey="6thBirthdayGate" width="320" height="320" soundID="5" textX="3" textY="-20" displayTextKey="gate_billboard_birthday_6"/>
...
<!-- 			<drone id="3" level="5" resKey="dronec5" droneRadius="15"/> -->
		...
		<droneFormations>
			<formation id="0" name="standard">
				...
				<positionsList data="150,0;225,0;187.5,37.5;187.5,-37.5;-37.5,-150;37.5,-150;0,-112.5;0,-187.5;-37.5,150;37.5,150;0,187.5;0,112.5" />
				<scale>1.0</scale>
			...
			<formation id="1" name="turtle">
				<positionsList data="-100,-50;-100,50;-50,-100;-50,100;0,-150;0,150;50,-100;50,100;100,-50;100,50;-100,0;100,0"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
			...
			<formation id="2" name="arrow">
				<positionsList data="-100,-25;-100,25;-50,-50;-50,50;0,-75;0,75;50,-100;50,100;100,-125;100,125;150,-150;150,150"/> 
		 		<scale>1.5</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="4" name="star">
				<positionsList data="-50,-50;-50,50;0,-75;0,75;75,0;150,0;0,-150;0,150;-100,-100;-100,100;0,-112.5;0,112.5"/> 
		 		<scale>1.8</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="6" name="doublearrow">
				<positionsList data="-50,-150;-50,150;0,-125;0,125;50,-100;50,100;0,-175;0,175;50,-200;50,200;100,-75;100,75"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="7" name="diamond">
				<positionsList data="0,-200;0,200;150,0;-150,0;75,-100;75,100;-75,-100;-75,100;0,-100;0,100;-112.5,-50;-112.5,50"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="8" name="doublechevron">
				<positionsList data="-150,0;-100,-50;-100,50;100,0;150,-50;150,50;-50,-100;-50,100;0,-150;0,150;125,-25;125,25"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="9" name="moth">
				<positionsList data="-150,-150;-150,150;-100,-200;-100,200;-100,-100;-100,100;75,-75;75,75;125,-125;125,125;-125,-125;-125,125"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
			...
			<formation id="10" name="crab">
				<positionsList data="-75,-75;-75,75;100,-50;100,50;0,-150;0,150;-150,-150;-150,150;-225,-125;-225,125;50,-100;50,100"/> 
		 		<scale>1.3</scale>
		 		<usedPositions droneCount="0" positionIDlist=""/>
		 		<usedPositions droneCount="1" positionIDlist="1"/>
		 		<usedPositions droneCount="2" positionIDlist="1,2"/>
...
<!-- 			<laser salvoID="13" class="6" type="0" resKey="crystal2" skillResKey="-1" fireRate="2000" comment="crystal 2" speed="0.5" playLoop="true" soundID="17"/> -->
		...
		<laserDefinitions>
			<laser salvoID="0" resKey="laser0" skillResKey="skillLaser0" fireRate="400" comment="red laser" soundID="0" laserFlashID="0" laserLength="80"/>
			<laser salvoID="1" resKey="laser1" skillResKey="skillLaser1" fireRate="400" comment="blue laser" soundID="9" laserLength="80"/>
			<laser salvoID="2" resKey="laser2" skillResKey="skillLaser2" fireRate="400" comment="green laser" soundID="10" laserLength="80"/>
			<laser salvoID="3" resKey="laser3" skillResKey="skillLaser3" fireRate="400" comment="white laser" soundID="11" laserLength="80"/>
			<laser salvoID="4" resKey="laser4" skillResKey="skillLaser4" fireRate="200" comment="blue absorber" soundID="13" absorber="true" speed="0.5"/>
			<laser salvoID="5" resKey="laser5" skillResKey="skillLaser5" fireRate="400" comment="pommes schuss" soundID="39" laserLength="80"/>
			<laser salvoID="6" resKey="laser6" skillResKey="skillLaser6" fireRate="100" comment="pulse laser" soundID="32" laserLength="60" attackLength="400"/>
			<laser salvoID="7" resKey="elaCloud1" skillResKey="elaCloud1" fireRate="4000" comment="cloud from target to attacker, when ela active" soundID="32" laserLength="0" speed="0.5"/>
			
			<laser salvoID="8" resKey="nettel" skillResKey="-1" fireRate="1000" comment="nettel" laserLength="40" soundID="15"/>
			<laser salvoID="9" resKey="protegitShot" skillResKey="-1" fireRate="1000" comment="protegit Shot" soundID="19" speed="0.5" laserLength="0"/>
			<laser salvoID="10" resKey="crystal_blue" skillResKey="-1" fireRate="2000" comment="crystal blue" speed="0.5" playLoop="false" soundID="17"/>
			<laser salvoID="11" resKey="devolariumShot" skillResKey="-1" fireRate="400" comment="like clouds" playLoop="true" speed="0.75" soundID="16"/>
			<laser salvoID="12" resKey="lordakiumShot" skillResKey="-1" fireRate="1000" comment="like squid" playLoopRotated="true" speed="0.3" soundID="15"/>
			<laser salvoID="13" resKey="crystal_red" skillResKey="-1" fireRate="2000" comment="crystal red" speed="0.5" playLoop="false" soundID="17"/>
			<laser salvoID="14" resKey="footballLaser" skillResKey="footballLaser" fireRate="400" comment="football laser" soundID="0" ignoreLaserPoints="true" laserFlashID="0" laserLength="80"/>
			<laser salvoID="15" resKey="footballAbsorber" skillResKey="footballAbsorber" fireRate="400" comment="football absorber" soundID="13" absorber="true" speed="0.5"/>
			<laser salvoID="16" resKey="devolariumShot" skillResKey="-1" fireRate="700" comment="like clouds, but slower" playLoop="true" speed="0.85" soundID="16"/>
			<laser salvoID="17" resKey="sibelonShot" skillResKey="-1" fireRate="400" comment="like clouds" playLoop="true" speed="0.75" soundID="16"/>	
			<laser salvoID="18" resKey="crystal_white" skillResKey="-1" fireRate="2000" comment="crystal white" speed="0.5" playLoop="false" soundID="17"/>	
			<laser salvoID="19" resKey="lordakiumShotSolarClash" skillResKey="-1" fireRate="2000" comment="crystal white" speed="0.5" playLoop="false" soundID="17"/>	
			
			<laser salvoID="20" resKey="laser_hitec_mothership" skillResKey="-1" fireRate="500" comment="dark blue laser" soundID="110"/>
			<laser salvoID="21" resKey="laser_hitec_minion" skillResKey="-1" fireRate="3000" comment="bright blue laser" soundID="111"/>
			<laser salvoID="22" resKey="laser_halloween" skillResKey="-1" fireRate="3000" comment="bright blue laser" soundID="111"/>
		...
		<collectables>
			...
			<collectable class="0" id="5" resKey="bigPumpkin" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="6" resKey="orangePumpkin" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			...
			<collectable class="0" id="10" resKey="flower_mothersday" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="11" resKey="theItalianBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			...
			<collectable class="0" id="19" resKey="bonusBoxSun" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true" />
<!-- 			This is currently implemented on my checkout of the trunk, called 'trunknew'. It's here just to illustrate why pirate booty is 21 -->
			<collectable class="0" id="20" resKey="petWeekBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="21" resKey="pirateBootyBox" soundID="3" useBitmapClip="true" isHarvestable="true" hasSimpleRapresentation="true" precache="true"/>
			<collectable class="0" id="22" resKey="pirateBootyGoldBox" soundID="3" useBitmapClip="true" isHarvestable="true" hasSimpleRapresentation="true" precache="true"/>
			<collectable class="0" id="23" resKey="hungarianRevolutionBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="24" resKey="stpatricksDayBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="25" resKey="titanicBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="26" resKey="brazilBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="27" resKey="victoryFrBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="28" resKey="victoryRuBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="29" resKey="victoryCzBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="30" resKey="boxStar" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="31" resKey="pirateBootyRedBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true" precache="true"/>
			<collectable class="0" id="32" resKey="pirateBootyBlueBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true" precache="true"/>
			<collectable class="0" id="33" resKey="victoryFrBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="34" resKey="mexicanBonusBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="35" resKey="boxAntec" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="36" resKey="germanUnificationDayBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="37" resKey="hispanicDayBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="38" resKey="candyBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="39" resKey="birthdayBox" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			<collectable class="0" id="40" resKey="treasureChest" soundID="3" useBitmapClip="true" hasSimpleRapresentation="true"/>
			
			<collectable class="1" id="0" resKey="oreRed" soundID="3" duration="1000" objectPool="true" useBitmapClip="true" precache="true" hasSimpleRapresentation="true" />
			<collectable class="1" id="1" resKey="oreBlue" soundID="3" duration="1000" objectPool="true" useBitmapClip="true" precache="true" hasSimpleRapresentation="true"/>
			<collectable class="1" id="2" resKey="oreYellow" soundID="3" duration="1000" objectPool="true" useBitmapClip="true" precache="true" hasSimpleRapresentation="true"/>
			<collectable class="1" id="8" resKey="ore_palladium" soundID="3" duration="1000" objectPool="true" useBitmapClip="true" hasSimpleRapresentation="true"/>

			<collectable class="2" id="112" resKey="beacon_1_2" easterResKey="beacon_easter_1_2" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="113" resKey="beacon_1_3" easterResKey="beacon_easter_1_3" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="121" resKey="beacon_2_1" easterResKey="beacon_easter_2_1" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="123" resKey="beacon_2_3" easterResKey="beacon_easter_2_3" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="131" resKey="beacon_3_1" easterResKey="beacon_easter_3_1" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="132" resKey="beacon_3_2" easterResKey="beacon_easter_3_2" soundID="3" hasSimpleRapresentation="true"/>

			<collectable class="2" id="212" resKey="beacon_1_2" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="213" resKey="beacon_1_3" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="221" resKey="beacon_2_1" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="223" resKey="beacon_2_3" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="231" resKey="beacon_3_1" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
			<collectable class="2" id="232" resKey="beacon_3_2" additionalLayers="olympicTorch" soundID="3" hasSimpleRapresentation="true"/>
...
<!-- 		    <track id="1" resKey="track1" volume="1"/> -->
		...
		<pyroEffects>
			<pyroEffect class="0" id="0" resKey="explosion0" soundID="1" useBitmapClip="true" precache="true" rotatable="true"/>
			...
			<pyroEffect class="0" id="6" resKey="explosion0" soundID="1" useBitmapClip="true" displayShockwave="true" rotatable="true"/>
...
<!-- banner billboards ............................................................................................................................. 
		 ...
		 -= optional values: =-
		  ...
		  -->
		<billboards>
			<billboard id="1" resKey="billboard1" advertX="32" advertY="38" oscillationAmplitude="10" oscillationDuration="3" minimapIcon="mapIcon_billboard" />
			<billboard id="2" resKey="billboard_green" advertX="22" advertY="20" oscillationAmplitude="10" oscillationDuration="3" minimapIcon="mapIcon_billboard" />
		</billboards>
		...
		<bannerads>
			...
			<bannerad id="10" enumName="partner_antec" baseKey="partner_antec" assetCount="1" url="http://www.antec.com"/>
			<bannerad id="11" enumName="partner_razer" baseKey="partner_razer" assetCount="1" url="http://www.razerzone.com/"/>
		</bannerads>
		<techs>
		...
		<petgears normalState="bg_standard.png" activeState="bg_active.png">
			...
			<gear id="5" effect="" effectTarget="" targetList="" suffix="" resKey="autoressource.png" name="g-ar1_name"/>
			<gear id="6" effect="1" effectTarget="hero" targetList="npc" suffix="_icon.png" resKey="enemylocator.png" name="g-el1_name"/>
			<gear id="7" effect="1" effectTarget="hero" targetList="ore" suffix="" resKey="resourcelocator.png" name="g-rl1_name"/>
			...
			<gear id="1" effect="" effectTarget="" targetList="" suffix="" resKey="passive.png" name="passive_mode_name"/>
			<gear id="2" effect="" effectTarget="" targetList="" suffix="" resKey="guard.png" name="guard_mode_name"/>
			<gear id="11" effect="" effectTarget="" targetList="" suffix="" resKey="combo-ship-repair.png" name="csr-02_name"/>
			<gear id="12" effect="" effectTarget="" targetList="" suffix="" resKey="combo-guard.png" name="cgm-02_name"/>
		...
		<petBuffs>
			...
			<buff id="6" effect="" resKey="combo-repair_gear_cooldown.png" languageKey="ttip_pet_combo-repair-gear_cooldown"/>
		</petBuffs>
		<effects>
